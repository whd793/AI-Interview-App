...
function RecordAnswerSection({
  ...
  const {
    error,
    interimResult,
    isRecording: isSpeechToTextRecording,
    results,
    startSpeechToText,
    stopSpeechToText,
    setResults,
  ...
  // Function to request permissions and initialize recognition
  ...
  const startRecording = useCallback(async () => {
    ...
    try {
      // Request permissions and initialize recognition if needed
      if (!recognition) {
  ...
  }, [recognition, startSpeechToText, transcriptionTimeout, selectedLanguage]);
  ...
  const stopRecording = useCallback(async () => {
    try {
      ...
      toast.error(t('recordingStopError'));
    }
  }, [recognition, stopSpeechToText, userAnswer]);
